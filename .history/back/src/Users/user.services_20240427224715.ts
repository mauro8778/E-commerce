...
export class userServices {
  ...
  createUser(userRepository: Partial<UserEntity>) {
    return this.userRepository.createRepository(userRepository);
  }
  updateUser(id: string, update: userdto): Promise<Users | null> {
