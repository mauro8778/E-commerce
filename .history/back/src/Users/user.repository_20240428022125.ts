...
private readonly userRepository: Repository<UserEntity>
  ...
  async getUserRepository(page: number = 1, limit: number = 5) {
    ...
    return this.userRepository.find({ skip: start, take: limit, select: ['id', 'name', 'email', 'address', 'phone', 'country', 'city'] });
  }
...
const newUser = this.userRepository.create(userRepository);
  ...
  async updateUsersRepository(id: string, update: UserEntity) {
